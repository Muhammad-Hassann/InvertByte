  ...
  return (
    <section className="section-padding">
      <div className="container-tight">
        ...
        <div className="rounded-2xl border border-border bg-card p-4 sm:p-6 glow-border max-w-5xl mx-auto">
          {/* Browser chrome */}
          <div className="flex items-center gap-2 mb-4 sm:mb-6">
            <div className="h-3 w-3 rounded-full bg-destructive/60" />
            <div className="h-3 w-3 rounded-full bg-yellow-500/60" />
            <div className="h-3 w-3 rounded-full bg-green-500/60" />
            <div className="flex-1 mx-2 sm:mx-4 h-6 sm:h-7 rounded-lg bg-muted flex items-center px-3 overflow-hidden">
              <span className="text-[9px] sm:text-[10px] text-muted-foreground truncate">
                invertbyte.com/dashboard
              </span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] gap-4">
            ...
            <div className="rounded-xl bg-muted/30 p-3 sm:p-4">
              <div className="font-display text-sm font-bold text-foreground mb-3 sm:mb-4">
                Store<span className="gradient-text">AI</span>
              </div>

              {/* Horizontal scroll menu on mobile */}
              <div className="flex lg:block gap-2 lg:space-y-3 overflow-x-auto lg:overflow-visible">
